<template>
    <div class="HomeFirst">
        <div class="HomeFirst_header">
            <img class="HomeFirst_header_img" src="../../../assets/showOffHome/home1/header.png" alt=""/>
        </div>
        <div class="HomeFirst_PlugIn">
            <!--<div class="HomeFirst_PlugIn_Broadcast">
                <div class="HomeFirst_PlugIn_Broadcast_content">
                    <i class="iconfont">&#xe614;</i>
                    <span>凌晨二时 蔡甸服务区因为XXX 已临时关闭 预计XXX开放</span>
                </div>
            </div>-->
            <div class="HomeFirst_PlugIn_Time-Theme">
                <span>{{nowTime}}</span>
        ...
        <div class="HomeFirst_container">
            <div class="HomeFirst_content">
                <div class="HomeFirst_content_content">
                    <ul class="HomeFirst_content_content_top">
                        <li class="HomeFirst_content_content_top_left">
                            <ul class="sm_cc">
                                <li>
                                    <MsECharts :optionData="ECData[0]" plug-in="HomeFirstPlugIn" e-c-id="a" ref="0"
                                               title="预算控制率"></MsECharts>
                                </li>
                                <li>
                                    <MsECharts :optionData="ECData[1]" plug-in="HomeFirstPlugIn" e-c-id="b" ref="1"
                                               title="回款率"></MsECharts>
                                </li>
                                <li>
                                    <MsECharts :optionData="ECData[2]" plug-in="HomeFirstPlugIn" e-c-id="c" ref="2"
                                               title="合同未收款"></MsECharts>
                                </li>
                            </ul>
                        </li>
                        <li class="HomeFirst_content_content_top_center">
                            <div class="HomeFirst_content_content_top_center_search">
                            ...
                            <div class="HomeFirst_content_content_top_center_type">
                        ...
                        <li class="HomeFirst_content_content_top_right">
                            <ul class="sm_cc">
                                <li>
                                    <MsECharts :optionData="zhl" plug-in="HomeFirstPlugIn" e-c-id="d" title="转化率"
                                               ref="zhl">
                                        <div slot="content"
                                ...
                                <li>
                                    <MsECharts :optionData="jyph" plug-in="HomeFirstPlugIn" e-c-id="e" title="经营排行"
                                               ref="jyph">
                                        <div slot="content"
                                             style="display: flex;flex-direction: row;flex-wrap: nowrap;height: 100%">
                                            <div class="bll">
                    ...
                    <div class="HomeFirst_content_content_bottom">
                        ...
                        <div class="HomeFirst_content_content_bottom_content">
                            <ul>
                                <li>
                                    <MsECharts :optionData="ECData[3]" plug-in="HomeFirstPlugIn" e-c-id="f" ref="3"
                                               title="实业公司"></MsECharts>
                                </li>
                                <li>
                                    <MsECharts :optionData="ECData[4]" plug-in="HomeFirstPlugIn" e-c-id="g" ref="4"
                                               title="服务区板块"></MsECharts>
                                </li>
                                <li>
                                    <MsECharts :optionData="ECData[5]" plug-in="HomeFirstPlugIn" e-c-id="h" ref="5"
                                               title="能源板块"></MsECharts>
                                </li>
                                <li>
                                    <MsECharts :optionData="ECData[6]" plug-in="HomeFirstPlugIn" e-c-id="i" ref="6"
        ...
        methods: {
            ...
            formatter(d, a, b, c) {
                ...
                d.forEach(i => {
                    ...
                    obj.value.unshift(parseInt(i[b]))
                });
                return obj;
            },
            ...
            ranking(selected, changeValue) {
                ...
                this.$axios.get('/api' + url, {params: param}).then(res => {
                    ...
                    let type = this.DeepCopy(param.type);
                    if (type == "ZhuanHuan") {
                        type = "zhuanHuan"
                    }
                    let fd = this.formatter(data, 'name', type);
...
<style scoped lang="less">
    .HomeFirst {
        ...
        background-image: url("../../../assets/showOffHome/home1/background.png");
        ...
        .HomeFirst_header {
            ...
            .HomeFirst_header_img {
                position: absolute;
            }
        }

        @HomeFirst_PlugIn_Height: 30px;

        .HomeFirst_PlugIn {
            height: @HomeFirst_PlugIn_Height;
            width: 100%;
            position: relative;

            .HomeFirst_PlugIn_Broadcast {
                width: 48%;
                height: @HomeFirst_PlugIn_Height;
                position: absolute;
                top: 0;
                ...
                .HomeFirst_PlugIn_Broadcast_content {
                    width: calc(100% - 20px);
                    line-height: @HomeFirst_PlugIn_Height;
                    margin: 0 10px;
        ...
        .HomeFirst_container {
            ...
            .HomeFirst_content {
                ...
                background-image: url("../../../assets/showOffHome/home1/border.png");
                background-size: 100% 100%;
                background-repeat: no-repeat;

                .HomeFirst_content_content {
                    width: 100%;
                    height: 100%;

                    .HomeFirst_content_content_top {
                        width: 100%;
                        ...
                        .HomeFirst_content_content_top_left {
                            width: 18%;
                            height: 100%;
                        ...
                        .HomeFirst_content_content_top_center {
                            width: 54%;
                            height: 100%;
                            position: relative;
                            overflow: hidden;

                            .HomeFirst_content_content_top_center_search {
                                position: absolute;
                                z-index: 10;
                                width: 200px;
                                height: 35px;
                            ...
                            .HomeFirst_content_content_top_center_type {
                                position: absolute;
                                z-index: 10;
                                top: 0;
                                right: -80px;
                        ...
                        .HomeFirst_content_content_top_center:hover .HomeFirst_content_content_top_center_type {
                            right: 0;
                        }

                        .HomeFirst_content_content_top_right {
                            width: 27%;
                            height: 100%;
                    ...
                    .HomeFirst_content_content_bottom {
                        width: 100%;
                        height: 200px;
                        display: flex;
                        flex-wrap: nowrap;
                        ...
                        .HomeFirst_content_content_bottom_button {
                            width: 30px;
                            height: 100%;
                            display: flex;
                            flex-direction: column;
                        ...
                        .HomeFirst_content_content_bottom_content {
                            width: calc(100% - 40px);
                            height: 100%;
