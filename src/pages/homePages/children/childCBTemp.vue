<template>
    <div class="CBT">
        <div class="tab">
            <img src="../../../assets/nh_img/icon.1.png" alt=""/>
            <img @click="selectCompay('1')"
                 :src="selected==='1'?require('../../../assets/nh_img/s1.png'):require('../../../assets/nh_img/u1.png')"
                 alt=""/>
            <img @click="selectCompay('2')"
                 :src="selected==='2'?require('../../../assets/nh_img/s2.png'):require('../../../assets/nh_img/u2.png')"
                 alt=""/>
            <img @click="selectCompay('3')"
                 :src="selected==='3'?require('../../../assets/nh_img/s3.png'):require('../../../assets/nh_img/u3.png')"
                 alt=""/>
            <img @click="selectCompay('4')"
                 :src="selected==='4'?require('../../../assets/nh_img/s4.png'):require('../../../assets/nh_img/u4.png')"
                 alt=""/>
            <img @click="selectCompay('5')"
                 :src="selected==='5'?require('../../../assets/nh_img/s5.png'):require('../../../assets/nh_img/u5.png')"
                 alt=""/>
            <img src="../../../assets/nh_img/icon.7.png" alt=""/>
        </div>
        <div class="charts">
